...
int main(){
    ...
    {MEASURE_SCOPE("GA_BIN::Population::_refresh_selection(GA_BIN::SelMethods::BEST)");
        population._refresh_selection(GA_BIN::SelMethods::BEST);
    }
    {MEASURE_SCOPE("GA_BIN::Population::_refresh_selection(GA_BIN::SelMethods::RANDOM)");
        population._refresh_selection(GA_BIN::SelMethods::RANDOM);
    }
    {MEASURE_SCOPE("GA_BIN::Population::_mutation()");
